    ...
    <nav className="bg-black/90 text-white shadow-lg fixed top-0 left-0 w-full z-50 border-b border-white/5">
      <div className="px-6 md:px-12 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* AUTH BUTTONS — akan diupdate setelah NextAuth siap */}
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link
              href="/register"
              className="text-sm bg-red-600 hover:bg-red-500 text-white px-4 py-1.5 rounded-full transition-colors font-medium"
            >
              Daftar
            </Link>
          </div>
