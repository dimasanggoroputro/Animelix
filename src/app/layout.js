    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          formFieldInput:
            "bg-zinc-900 border-white/10 text-white placeholder-gray-600 focus:border-red-500 focus:ring-red-500/20",
          formFieldInputShowPasswordButton: "text-gray-400 hover:text-white",
          formButtonPrimary:
            "bg-red-600 hover:bg-red-500 text-white font-semibold transition-colors shadow-lg shadow-red-900/30",
          formButtonReset: "text-gray-400 hover:text-white transition-colors",
          footerActionLink: "text-red-500 hover:text-red-400 font-medium transition-colors",
          footerActionText: "text-gray-500",
          footer: "border-t border-white/5",
          identityPreviewText: "text-white",
          identityPreviewEditButton: "text-red-500 hover:text-red-400",
          otpCodeFieldInput:
            "bg-zinc-900 border-white/10 text-white focus:border-red-500",
          alert: "bg-zinc-900 border border-white/10",
          alertText: "text-gray-300",
          userButtonPopoverCard:
            "bg-zinc-950 border border-white/10 shadow-2xl shadow-black/50",
